package stdlib; /******************************************************************************
 *  Compilation:  javac stdlib.BinaryIn.java
 *  Execution:    java stdlib.BinaryIn input output
 *  Dependencies: none             
 *  
 *  This library is for reading binary data from an input stream.
 *
 *  % java stdlib.BinaryIn https://introcs.cs.princeton.edu/java/cover.png output.png
 *
 ******************************************************************************/
 ...
 *  byte first) order.
 *  <p>
 *  The client should not intermix calls to {@code stdlib.BinaryIn} with calls
 *  to {@code stdlib.In}; otherwise unexpected behavior will result.
 *
...
public final class BinaryIn {
   ...
   /**
     * Unit tests the {@code stdlib.BinaryIn} data type.
