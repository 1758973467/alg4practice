package stdlib; /******************************************************************************
 *  Compilation:  javac stdlib.BinaryStdOut.java
 *  Execution:    java stdlib.BinaryStdOut
 *  Dependencies: none
 *
 ...
 *  <p>
 *  The client should not intermix calls to {@code stdlib.BinaryStdOut} with calls
 *  to {@code stdlib.StdOut} or {@code System.out}; otherwise unexpected behavior
 *  will result.
 *
...
public final class BinaryStdOut {
    ...
    private static boolean isInitialized;     // has stdlib.BinaryStdOut been called for first time?

    // don't instantiate
    private BinaryStdOut() { }

    // initialize stdlib.BinaryStdOut
