package stdlib; /******************************************************************************
 *  Compilation:  javac stdlib.BinaryOut.java
 *  Execution:    java stdlib.BinaryOut
 *  Dependencies: none
 *
 ...
 *  <p>
 *  The client should not intermix calls to {@code stdlib.BinaryOut} with calls
 *  to {@code stdlib.Out}; otherwise unexpected behavior will result.
 *
