...
public final class In {
    ...
    ///// begin: section (1 of 2) of code duplicated from stdlib.In to stdlib.StdIn.
    ...
    //// end: section (1 of 2) of code duplicated from stdlib.In to stdlib.StdIn.
   ...
   /**
    ...
    public In(File file) {
        ...
        try {
            // for consistency with stdlib.StdIn, wrap with BufferedInputStream instead of use
   ...
   /**
    ...
    ////  begin: section (2 of 2) of code duplicated from stdlib.In to stdlib.StdIn,
   ...
   /**
    ...
    ///// end: section (2 of 2) of code duplicated from stdlib.In to stdlib.StdIn */
   ...
   /**
     ...
     * @deprecated Replaced by {@code new stdlib.In(filename)}.{@link #readAllInts()}.
     */
    @Deprecated
   ...
   /**
     ...
     * @deprecated Replaced by {@code new stdlib.In(filename)}.{@link #readAllDoubles()}.
     */
    @Deprecated
   ...
   /**
     ...
     * @deprecated Replaced by {@code new stdlib.In(filename)}.{@link #readAllStrings()}.
     */
    @Deprecated
   ...
   /**
     * Unit tests the {@code stdlib.In} data type.
     *
