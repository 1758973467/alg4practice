package stdlib; /******************************************************************************
 *  Compilation:  javac stdlib.BinaryStdIn.java
 *  Execution:    java stdlib.BinaryStdIn < input > output
 *  Dependencies: none             
 *  
 *  Supports reading binary data from standard input.
 *
 *  % java stdlib.BinaryStdIn < input.jpg > output.jpg
 ...
 *  byte first) order.
 *  <p>
 *  The client should not intermix calls to {@code stdlib.BinaryStdIn} with calls
 *  to {@code stdlib.StdIn} or {@code System.in};
...
public final class BinaryStdIn {
    ...
    private static boolean isInitialized;   // has stdlib.BinaryStdIn been called for first time?
   ...
   /**
    ...
    public static void close() {
        ...
        try {
            ...
            throw new IllegalStateException("Could not close stdlib.BinaryStdIn", ioe);
        }
    }
