package stdlib; /******************************************************************************
 *  Compilation:  javac stdlib.GrayscalePicture.java
 *  Execution:    java stdlib.GrayscalePicture imagename
 *  Dependencies: none
 *
 ...
 *
 *  % java stdlib.GrayscalePicture mandrill.jpg
 *
 *  Remarks
 *  -------
...
public final class GrayscalePicture implements ActionListener {
   ...
   /**
     * Unit tests this {@code stdlib.Picture} data type.
