package stdlib; /******************************************************************************
 *  Compilation:  javac stdlib.StopwatchCPU.java
 *  Execution:    none
 *  Dependencies: none
 *
 *  A version of chapter1.Stopwatch.java that measures CPU time on a single
...
/**
 *  The {@code stdlib.StopwatchCPU} data type is for measuring
