package stdlib; /******************************************************************************
 *  Compilation:  javac stdlib.Draw.java
 *  Execution:    java stdlib.Draw
 *  Dependencies: none
 *
...
/**
 *  <i>stdlib.Draw</i>. This class provides a basic capability for
...
public final class Draw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    // name of window
    private String name = "stdlib.Draw";
    ...
    ***************************************************************************/
     ...
     *
     * @param listener the {\tt stdlib.DrawListener} argument
     */
