...
/**
 * Test client for stdlib.StdIn and stdlib.In.
 **/
...
public class StdInTest {
    ...
    public static void main(String[] args) {
        ...
        if (testStdIn) 
            ...
            StdOut.println("Note: stdlib.StdIn.resync is private, only stdlib.In will be tested.");
